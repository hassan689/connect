...
/// Reusable shimmer loading widgets for the app
...
class ShimmerLoading {
  ...
  /// Shimmer effect for message list items
  static Widget messageItem() {
    return Shimmer.fromColors(
      baseColor: Colors.grey[300]!,
      highlightColor: Colors.grey[100]!,
      child: Container(
  ...
  /// Shimmer effect for notification items
  ...
  /// Shimmer effect for dashboard stats
  static Widget dashboardStat() {
    return Shimmer.fromColors(
      baseColor: Colors.grey[300]!,
      highlightColor: Colors.grey[100]!,
      child: Container(
  ...
  /// Shimmer effect for list items (generic)
  static Widget listItem({double? height}) {
    return Shimmer.fromColors(
      baseColor: Colors.grey[300]!,
      highlightColor: Colors.grey[100]!,
      child: Container(
  ...
  static Widget textLines({int lines = 3}) {
    return Shimmer.fromColors(
      baseColor: Colors.grey[300]!,
      highlightColor: Colors.grey[100]!,
      child: Column(
  ...
  /// Shimmer effect for profile page
